...
import com.example.wiserrapps.component.TopBarWithTabs
...
fun MainScreen(navController: NavHostController = rememberNavController()) {
    ...
    val data = when (selectedTabIndex) {
        ...
        2 -> listOf(
            Materi("Menuju Sukses dengan Budidaya Sarang Burung Walet", "Artikel menarik", R.drawable.artikel1),
            Materi("Kandungan Nitrit pada Sarang Burung Walet", "Artikel kesehatan", R.drawable.artikel2)
        )
